...
##   $ docker build -t tomcat-for-lodotek-sapho-mysql-docker-azure .
##
## RUNNING
##   $ docker run -p 8080:8080 tomcat-for-lodotek-sapho-mysql-docker-azure
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="dyq3tvf" \
    STACKSMITH_STACK_NAME="Tomcat for lodotek/sapho-mysql-docker-azure" \
